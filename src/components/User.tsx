const User: React.FC = () => {
    return (
        <div className="mt-[16px] pt-[32px] px-[24px] pb-[48px] rounded-[15px] bg-[#fefefe] shadow-custom max-w-[327.2px] tablet:p-[40px] tablet:mt-[24px] tablet:max-w-[573px]">
            <div className="flex items-center gap-[19px] tablet:gap-[41px]">
                <img src="/user.png" alt="User-avatar" className="w-[70px] h-[70px] rounded-[50%] tablet:w-[117px] tablet:h-[117px]"/>
                <div>
                    ...
                    <p className="text-[13px] font-normal leading-normal text-left text-[#697c9a] tablet:tex-[15px] tablet:mt-[4px]">Joined 25 Jan 2011</p>
                </div>
            </div>
            ...
            <div className="flex justify-around pt-[18px] pr-[14px] pb-[19px] pl-[15px] rounded-[10px] bg-[#f6f8ff] mt-[23px] tablet:pt-[15px] tablet:pr-[96px] tablet:pb-[17px] tablet:pl-[32px] tablet:mt-[32px]">
                <div>
            ...
            <div className="flex flex-col mt-[24px] tablet:mt-[30px] tablet:flex-row tablet:items-center tablet:gap-[65px]">
                <div>
                    <div className="flex">
