    ...
    >
      ...
      <div>
        ...
        <div className="flex flex-col mt-[24px] tablet:mt-[30px] tablet:flex-row tablet:items-center tablet:gap-[65px] desktop:mt-[37px]">
          <div>
            <div className={`flex ${user?.location ? "" : " opacity-50"}`}>
            ...
            <div
              className={`flex mt-[17px] ${user?.blog ? "" : " opacity-50"}`}
            >
          ...
          <div>
            <div
              className={`flex mt-[17px] tablet:mt-[0px] ${
            ...
            <div
              className={`flex mt-[16px] ${user?.company ? "" : " opacity-50"}`}
            >
              <svg height="20" width="20" xmlns="http://www.w3.org/2000/svg">
                <g fill="#4b6a9b">
